                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div><?php echo _('The pretty parameter cannot be used with'); ?> <code>outputtype=xml</code></div>
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
<pre>{
    ...
    "name": "localhost_PING_rta"
                ...
                <div class="help-section obj-reference">
                    ...
                    <p><?php echo _('This endpoint returns host availability information for a speficied, host, hostgroup, or servicegroup. While there are no required paramteres, you must have at least one host, service, hostgroup, or servicegroup in your query.'); ?></p>
                    <div style="margin-bottom: 20px;">
                        <h6>Arguments:</h6>
                        <?php
    ...
    "hostavailability": [
        {
            ...
            "percent_total_time_undetermined": 0
                ...
                <div class="help-section obj-reference">
                    ...
                    <p><?php echo _('This endpoint returns service availability information for a speficied, host, service, hostgroup, or servicegroup. You can define a host and service at the same time. While there are no required paramteres, you must have at least one host, service, hostgroup, or servicegroup in your query.'); ?></p>
                    <div style="margin-bottom: 20px;">
                        <h6>Arguments:</h6>
                        <?php
                            $av_argument_table = new help_table("Parameter", "Required", "Description", "Default");
    ...
    "serviceavailability": [
        {
            ...
            "percent_total_time_undetermined": 0
                ...
                <div class="help-section obj-reference">
                    ...
                    <p><?php echo _('This endpoint returns SLA information for a speficied, host, service, hostgroup, or servicegroup. You can define a host and service at the same time. While there are no required paramteres, you must have at least one host, service, hostgroup, or servicegroup in your query.'); ?></p>
                    <div style="margin-bottom: 20px;">
                        <h6>Arguments:</h6>
                        <?php
