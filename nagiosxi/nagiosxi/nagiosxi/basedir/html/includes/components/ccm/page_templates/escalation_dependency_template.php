...
?>
    <div id='tab1'>
        ...
        <div class="rightBox">
            ...
            ?>
            <div class="ccm-row">
                <button type="button" class='btn btn-sm btn-info btn-serviceBox' onclick="overlay('serviceBox')"><?php echo _("Manage Services"); ?> <span class="badge"><?php echo $ss; ?></span></button>
            </div>
            <?php
            }
            if ($this->exactType == 'serviceescalation') {
